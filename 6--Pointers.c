...
int main(){
	...
	//addition of the addresses of pointers
	...
	printf("\n*(meatballs+2) = %d.", *(meatballs+2)); //returns the value of the pointer at the start of the array + 2
	printf("\n*(meatballs+2) = %p.", (meatballs+2)); //returns the address of the pointer at the start of the array + 2
